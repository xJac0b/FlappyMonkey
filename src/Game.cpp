...
{
	//Init window
    this->window = std::make_unique<sf::RenderWindow>(sf::VideoMode::getDesktopMode(), "Flappy Monkey", sf::Style::Titlebar | sf::Style::Close);
    //Init State Data
    this->stateData = std::make_unique<StateData>(*this->window, this->states, this->event);
    //Push state  
